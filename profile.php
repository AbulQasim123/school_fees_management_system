<?php
	...
	if (isset($_POST['edit_user'])) {
		...
		if ($error == '') {
			...
			$query = "UPDATE sfms_admin SET admin_name = :admin_name, admin_email = :admin_email, admin_password = :admin_password WHERE admin_id = :admin_id";
	...
	$query = "SELECT * FROM sfms_admin WHERE admin_id = '".$_SESSION['admin_id']."' ";
	...
	<div class="row">
		<div class="col-md-6">
			<?php
				...
				if($message != '')
				{
					echo '<div class="alert alert-success alert-dismissible fade show">User Data Edited <button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>';
				}
			?>
			<div class="card mb-4">
